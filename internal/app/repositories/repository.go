...
//	return nil
//}
//func (m *URLInMemoryRepo) StoreNewUser(ctx context.Context, login string, hashedPassword []byte) error {
//	return nil
//}
//func (m *URLInMemoryRepo) GetUserHashPassword(ctx context.Context, login string) ([]byte, error) {
//	return nil, nil
//}
//
